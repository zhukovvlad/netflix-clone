...
const MobileMenu: React.FC<MobileMenuProps> = ({ visible }) => {
  ...
  return (
    <div className="bg-black w-56 absolute top-8 left-0 py-5 border-2 border-gray-800 flex">
      <div className="flex flex-col gap-4">
		...
		<div className="px-4 text-center text-white hover:underline">Browse by Languages</div>
      </div>
    </div>
  );
};
